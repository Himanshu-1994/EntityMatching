...
from transformers import AutoModel, AdamW, get_linear_schedule_with_warmup, GPT2ForSequenceClassification
    ...
    for epoch in range(1, hp.n_epochs+1):
        ...
        if dev_f1 > best_dev_f1:
            ...
            if hp.save_model:
                ...
                model_path = os.path.join(hp.logdir, hp.task, hp.lm)
                ...
                with open(os.path.join(model_path, 'report'),'w') as f:
                    f.write("Best epoch:{}\n".format(epoch))
                    f.write(f"epoch {epoch}: dev_f1={dev_f1}, f1={test_f1}, best_f1={best_test_f1}\n")
